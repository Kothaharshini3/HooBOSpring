...
public class HotelController {
	...
	@GetMapping ("/list")
	public List<Hotel> getAllHotelsData() {     
		List<Hotel> hotel =hotelSer.displayAll();
		return hotel;
	}
	@GetMapping ("/list/{hotelId}")
	public Hotel getHotelsData(@PathVariable ("hotelId") int hotelId) {      
	...
	public String deleteHotelsData(@PathVariable ("hotelId")int hotelId) {      
		Hotel hotel =hotelSer.getById(hotelId);
		if (hotel==null) { 
