...
public class LocationController {
	...
	@GetMapping ("/list")
	public List<Location> getAllLocationsData() {     
		List<Location> location =locationSer.displayAll();
		return location;
	}
	@GetMapping ("/list/{locationId}")
	public Location getLocationsData(@PathVariable ("locationId") int locationId) {      
...
//		location.setLocationId(0);
	...
	public String deleteLocationsData(@PathVariable ("locationId")int locationId) {      
		Location location =locationSer.getById(locationId);
		if (location==null) { 
